        ...
        <Grid item xs={12} md={12} lg={12} mt={2} >
          <Paper
            ...
            <div >
              <Grid>
                <p>{uid}</p>
                Email: <Input type='text' value={email} onChange={(e) => setEmail(email)} /><br />
                Confirm Passowrd: <Input required type='password' value={password || setPassword} onChange={(e) => setPassword(e.target.value)} /><br />
                Role: <Input type='text' readOnly value={role || setRole} onChange={(e) => setRole(role)} /><br />
                Created at.: <Input type='text' value={createdAt} onChange={(e) => setCreatedAt(createdAt)} /><br />
